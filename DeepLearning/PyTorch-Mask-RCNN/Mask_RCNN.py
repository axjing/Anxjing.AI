...
#masked2 = cv2.addWeighted(combined_masks, 0.5, mask2, 0.5, 0)

plt.imshow(masked1)

instance_segmentation_api('./mrcnn_standing_people.jpg', 0.75)

instance_segmentation_api('./mrcnn_cars.jpg', 0.9,
                          rect_th=5, text_size=5, text_th=5)

instance_segmentation_api('./mrcnn_traffic.jpg', 0.6,
                          rect_th=2, text_size=2, text_th=2)


instance_segmentation_api('./mrcnn_birds.jpg', 0.9)

instance_segmentation_api('./mrcnn_people.jpg', 0.8,
                          rect_th=1, text_size=1, text_th=1)

instance_segmentation_api('./mrcnn_playing.jpg', 0.8,
                          rect_th=6, text_size=6, text_th=6)

instance_segmentation_api('./mrcnn_cat_dog.jpg', 0.95,
                          rect_th=5, text_size=5, text_th=5)


instance_segmentation_api('./mrcnn_bear.jpg', 0.9,
                          rect_th=6, text_size=5, text_th=5)


instance_segmentation_api('./mrcnn_elephants.jpg', 0.9,
                          rect_th=6, text_size=6, text_th=6)


instance_segmentation_api('./mrcnn_baby_teddy.jpg',
                          0.95, rect_th=6, text_size=6, text_th=6)


instance_segmentation_api('./mrcnn_ketchen.jpg', 0.8,
