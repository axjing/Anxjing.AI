'''
@Author: your name
@Date: 2019-12-03 11:04:01
@LastEditTime: 2019-12-03 11:08:34
@LastEditors: Please set LastEditors
@Description: In User Settings Edit
@FilePath: \axjingWorks\workspace\AcademicAN\TwoStage\GLGCM.py
'''
import cv2
import numpy as np
